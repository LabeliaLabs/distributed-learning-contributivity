...
# Thanks to imdb.load_data() reviews are already preprocess: a word is an integer from 3 to ..., ranked by its frequency in the dataset
...
out_of_vocabulary = 2  # The unrelevant words are replaced by out_of_vocabulary
