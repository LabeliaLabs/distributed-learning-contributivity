...
from subtest.utils import parse_command_line_arguments
...
def main():
    ...
    with contextlib.redirect_stdout(stream):
        ...
        utils.move_log_file_to_experiment_folder(info_logger_id,
                                                 experiment_path,
                                                 constants.INFO_LOGGING_FILE_NAME,
                                                 "INFO")
        utils.move_log_file_to_experiment_folder(info_debug_id,
                                                 experiment_path,
                                                 constants.DEBUG_LOGGING_FILE_NAME,
                                                 "DEBUG")
