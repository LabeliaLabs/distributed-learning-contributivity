...
def create_data_distribution_graph(name, ratio_partner_per_class, 
        ...
        :param corrupted_partners: dic (default is {} for no corruption), dictionary with the index of corrupted partners as key 
                                   and the proportion of corruption as value
        ...
        if save_folder is None and not display:
            warnings.warn("utils.create_data_distribution_graph() was called without setting the save_folder or the display option")
