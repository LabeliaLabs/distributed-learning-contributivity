...
def compute_SV_3partners(node_index, node_list):
    ...
    all_nodes = [i for i in range(len(node_list))]
    ...
    cf_all_nodes = fl_train(all_nodes)
    cf_other_nodes = fl_train(other_nodes)
    cf_A_B = fl_train(nodes_A_B)
    cf_A_C = fl_train(nodes_A_C)
    cf_B = fl_train(node_B)
    cf_C = fl_train(node_C)
...
def compute_SV_4partners(node_index, node_list):
    ...
    cf_A_B = fl_train(nodes_A_B)
    cf_A_C = fl_train(nodes_A_C)
    cf_A_D = fl_train(nodes_A_D)
    cf_B = fl_train(node_B)
    cf_C = fl_train(node_C)
    cf_D = fl_train(node_D)
    cf_A_B_C = fl_train(nodes_A_B_C)
    cf_A_B_D = fl_train(nodes_A_B_D)
    cf_A_C_D = fl_train(nodes_A_C_D)
    cf_B_C = fl_train(node_B_C)
    cf_B_D = fl_train(node_B_D)
    cf_C_D = fl_train(node_C_D)
