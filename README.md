...
There are two ways to run an experiment of multi-partner learning approaches and/or contributivity methods on a given dataset.
...
scenario0 = Scenario(partners_count=3,
                     amounts_per_partner=[0.2, 0.3, 0.5],
                     dataset_name='cifar10',
                     epoch_count=10,
                     minibatch_count=3,
                     )
scenario1 = Scenario(4, [0.25]*4)
scenario2 = Scenario(10, [0.1]*10)
scenario3 = Scenario(4, [0.8, 0.1, 0.05, 0.05])

exp = Experiment(experiment_name='my_first_experiment', nb_repeats=10, scenarios_list=[scenario0, scenario1, scenario3])
